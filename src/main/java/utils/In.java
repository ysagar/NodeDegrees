...
public final class In {
	...
	private static final java.util.Locale DEF_LOCALE = Locale.getDefault();
	...
	/**
	 * Reads all ints from a file <tt>new In(filename)</tt>.
	 * {@link #readAllInts()}
	 */
	...
	/**
	 * Reads all doubles from a file <tt>new In(filename)</tt>.
	 * {@link #readAllDoubles()}
	 */
	...
	/**
	 * Reads all strings from a file <tt>new In(filename)</tt>.
	 * {@link #readAllStrings()}
	 */
